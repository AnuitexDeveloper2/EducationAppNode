...
function removeAsync(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        logger_1.default.info(`>>>> authorService.remove(), with: Id = ${JSON.stringify(id)}`);
        if (!validateResult.valid) {
...
function getAsync() {
    return __awaiter(this, void 0, void 0, function* () {
        logger_1.default.info('>>>> authorService.get()');
        const result = yield authorRepository.GetAsync();
        if (result.length == 0) {
            logger_1.default.error('>>>> authorService.get(), list of authors is empty');
        }
        return result;
    });
}
