...
function getOrdersForAdminAsync(filter) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let count;
        let data = new Array();
        query = orders_1.default.find().populate("user_id").populate("items.OrderItem.printing_edition_id");
        const options = {
            sort: "_id",
            lean: true,
...
function getOrdersForUserAsync(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield orders_1.default.find({ user_id: id }).select("Items").populate("items.OrderItem.printing_edition_id");
        if (result.length == 0) {
            return null;
        }
        return result;
