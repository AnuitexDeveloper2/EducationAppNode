...
exports.orderUserRouter.use(accessController_1.checkPermission(role_1.Role.User));
exports.orderUserRouter.post('/', order_user_handler_1.createOrderAsync);
exports.orderUserRouter.get('/:id', order_user_handler_1.getOrderForUserAsync);
...
exports.orderAdminRouter.get('/', order_admin_handler_1.getOrdersAsync);
