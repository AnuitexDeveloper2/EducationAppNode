...
function createOrderAsync(orderParam) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        logger_1.default.info(`>>>> orderService.createOrder(), with: orderParam = ${JSON.stringify(orderParam)}`);
...
function getOrdersForUserAsync(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield orderRepository.getOrdersForUserAsync(id);
        if (result == null) {
...
function getOrdersForAdminAsync(filter) {
    return __awaiter(this, void 0, void 0, function* () {
        logger_1.default.info(`>>> orderService.getOrdersForAdmin(), with filter = ${JSON.stringify(filter)}`);
