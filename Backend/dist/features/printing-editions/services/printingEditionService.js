...
const currencyConverter_1 = require("../../shared/currencyConverter");
const currency_1 = require("../../shared/enums/currency");
...
function updateAsync(printingEditionParam, _id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield repository.updateAsync(printingEditionParam, _id);
        if (!result) {
...
function getPrintingEditionsAsync(filter) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        logger_1.default.info(`>>>> printingEditionService.get() with: params=${JSON.stringify(filter)}`);
        const result = yield repository.getPrintingEditionsAsync(filter);
        result.data.map((item) => (item.price = currencyConverter_1.Converter(currency_1.Currency.USD, filter.currency, item.price)));
        return result;
    });
}
