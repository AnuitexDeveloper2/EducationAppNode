        ...
        <div className="confirm-email-modal">
          <div className="confirm-email-inner">
           ...
           <div className="confirm-email-content">
                We have sent an e-mail with a confirmation link to your email<br/>
                adress.In order to complete the signUp progress, please click<br/>
                the confirmation link. <br/>
                <br/>
                If you do not receive a confirmation e-mail, please check the spam <br/>
                folder.Also, please verify that you entered a valid email adress in our <br/>
                sign-up form
           </div>
         </div>
        </div>
